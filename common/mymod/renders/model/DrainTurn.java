...
public class DrainTurn extends ModelBase {
    ...
    public DrainTurn() {
        ...
        modelDrain = AdvancedModelLoader.loadModel("/mods/MM/models/drainTurn.obj");
    }
    ...
    public void render(DrainTileEntity drain, double x, double y, double z, int direction) {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture("/mods/MM/textures/blocks/drainTurnUVmap.png");
